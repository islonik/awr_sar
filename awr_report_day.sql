...
select 
    ...
    to_char (trunc (sysdate) - 1, 'YYYYMMDD') cur_date
from dba_hist_snapshot
where trunc (sysdate)     between begin_interval_time and end_interval_time
   or trunc (sysdate) - 1 between begin_interval_time and end_interval_time
group by dbid;

host /bin/mkdir -p &cur_date.

spool &cur_date./awr_day_&cur_date._&snap_id1._&snap_id2..html
